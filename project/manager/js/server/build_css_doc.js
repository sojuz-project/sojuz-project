...
module.exports = {
  responce: (project, callback) => {
    fs.removeSync('/app/doc/css-doc');
    const css_doc_dir = '/app/doc/css-doc';
    const css_globals_doc_dir = '/app/doc/css-doc/globals';
    /**
      Preprocess
    */
    ...
    */
    ...
    callback({ doc: 'Documentation generated' });
  },
};
